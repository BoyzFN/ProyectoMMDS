...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference("Producto.count") do
      post productos_url, params: { producto: { costo: @producto.costo, descripcion: @producto.descripcion, existencias: @producto.existencias, id_producto: @producto.id_producto, nombre: @producto.nombre, precio_venta: @producto.precio_venta } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { costo: @producto.costo, descripcion: @producto.descripcion, existencias: @producto.existencias, id_producto: @producto.id_producto, nombre: @producto.nombre, precio_venta: @producto.precio_venta } }
